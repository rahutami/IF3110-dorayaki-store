    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="column">
                ...
                <input type="number" id="quantity" name="quantity" min="1" max="<?php echo $amountRemaining; ?>" required>
                <p>Total price: <span id="totalPrice"></span></p>
                <form action="" method="post" class="cartForm">
                    <button type="submit" name="submit" class="btn-jumbotron" style="
    font-weight: 600;
    text-transform: uppercase;">Buy</button>
                </form>
